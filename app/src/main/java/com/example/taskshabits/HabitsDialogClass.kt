...
class HabitsDialogClass(context: Context) : Dialog(context){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // init
        val titleEt = findViewById<EditText>(R.id.et_habits_title)
        val daysCountEt = findViewById<EditText>(R.id.et_habits_days_count)
